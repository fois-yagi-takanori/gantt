  ...
  setupTasks(tasks: Task[]): void {
    ...
    this.tasks = tasks.map((task, i): ResolvedTask => {
      ...
      const resolvedTask: ResolvedTask = {
        ...task,
        plannedStartResolved: dateUtils.parse(task.planStartDate),
        plannedEndResolved: dateUtils.parse(task.planEndDate),
        resultStartResolved: dateUtils.parse(task.resultStartDate),
        resultEndResolved: dateUtils.parse(task.resultEndDate),
        indexResolved: i,
        dependencies
      };
